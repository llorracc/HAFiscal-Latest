...
\ifbool{buffstk}{% For bufferstock paper
  ...
  \date[\today]{September 12, 2019  \\ \medskip \medskip \medskip \href{https://econ-ark.org/}{\small Powered By} \\ \includegraphics[width=0.5in]{econ-ark-logo-small.png}}
}{}
...
\frametitle{IRfs for extension of unemployment benefits}
	\centering
	\includegraphics[width=0.6\linewidth]{\econtexRoot/Code/HA-Models/FromPandemicCode/Figures/recession_UI_relrecession}
\begin{itemize}
	\itemsep = .5\bigskipamount 
...
\frametitle{IRFs for payroll tax cut}
	\centering
	\includegraphics[width=0.6\linewidth]{\econtexRoot/Code/HA-Models/FromPandemicCode/Figures/recession_taxcut_relrecession}
...
\end{equation*}
\centering
\includegraphics[width=0.5\linewidth]{\econtexRoot/Code/HA-Models/FromPandemicCode/Figures/Cummulative_multipliers}
\footnotesize
\begin{tabular}{@{}lccc@{}} 
