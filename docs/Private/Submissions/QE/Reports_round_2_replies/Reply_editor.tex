...
\textbf{Edmund: I think the reply is OK. I tried a footnote in the introduction, but it doesn't fit super nicely. I've added a sentence about that below.}
...
The model in \citet{melcangiStock} can account for consumption spikes among the wealthy. However, those occur in specific life situations which trigger the availability of the infrequent consumption good. In that case agents liquidate a large share of their savings and purchase the infrequent consumption good. Their paper makes no statements about how transitory shocks would affect wealthy agents, but we believe, the additional income would - at least in periods where the infrequent consumption good is not available - be used to save rather than to splurge as in our framework. Hence, while \citet{melcangiStock} can account well for the high saving rates wealth individuals exhibit on average, they cannot account for the MPCs significantly larger than zero that those wealthy individuals should also exhibit.

We have added a footnote in the `Related Literature' section of the introduction: ``Our modeling focus is to match the micro evidence on the intertemporal MPC. Other aspects of household behavior---such as stock market participation examined in \cite{melcangiStock}---are less directly relevant to the questions addressed in this paper.''
