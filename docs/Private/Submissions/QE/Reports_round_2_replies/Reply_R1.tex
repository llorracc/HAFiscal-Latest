...
\begin{enumerate}[label=(\alph*)]
	...
	\noindent \textbf{Response.} We agree that it would be useful to point this out, and we have added footnote 26 to our discussion of the multipliers in section 4.2: ``In the case that there is no aggregate demand effect, these multipliers converge to 1 as $t$ goes to infinity.'' (Also note that Table~5 is now Table~6, and Figure~7 is now Figures~4(d)-(f).)
