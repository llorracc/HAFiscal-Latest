...
%% Old figure did not work well with make4ht
%% \begin{figure}[htb]
%%   \centering
...
\afterpage{
  \thispagestyle{empty}
  \begin{table}[p]
    \caption{Model Parameters and Recession Configuration}
    \center
%    \begin{center}
      \begin{tabular}{c}
        \begin{tabular}{lcd{3}} 
...
% CDC: check citation to Graham and McDowall (2024). Add citation to Crawley as well?
