...
\ifthenelse{\boolean{Appendix}}{
  \appendix
  \subfile{Subfiles/Online-appendix}
  %%% AI's keep suggesting using \subimport, but for subtle reasons that fails
  %%%	\subimport{\econtexRoot/Subfiles/}{Online-appendix}\pagebreak
  \pagebreak
}{}
