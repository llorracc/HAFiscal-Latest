...
\begin{table}[t]
  ...
  \caption{Marginal propensities to consume across wealth quartiles and the total population as well as the wealth to income ratio, in the model with or without splurge an according to the data}
