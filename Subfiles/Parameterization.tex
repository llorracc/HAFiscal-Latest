...
Second, we calibrate the full model on US data taking the splurge-factor as given from the Norwegian calibration. In the model, agents differ according to their level of education and their subjective discount factors. Some parameters are calibrated equally for all of these different types, while some parameters are calibrated separately for each education group. Finally, a distribution of subjective discount factors is estimated separately for each education group to match features of the liquid wealth distribution within that group. 
...
\begin{tabular}{l}
	...
	\begin{tabular}{lccc}
		...
		& Dropout & Highschool & College \\ \midrule
		Median LW/ quartery PI (data) & 4.64 & 30.2 & 112.8 \\ 
		Median LW/ quartery PI (model) & 4.64 & 30.2 & 112.8 %\\
