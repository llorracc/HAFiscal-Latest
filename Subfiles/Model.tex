...
\begin{align}
  ...
  \mathbf{m}_{i,t+1} &= (R/\hat{\Gamma}_{i,t+1}) \mathbf{a}_{i,t} + (1-\varsigma) \mathbf{y}_{i,t+1}, \\
  \mathbf{a}_{i,t} &\geq 0,   \notag
\end{align}
where $R$ is the gross interest factor for accumulated assets $\mathbf{a}_{i,t}$ and $\hat{\Gamma}_{i,t+1}$ is the realized growth rate of permanent income from period $t$ to $t+1$, discussed further later.
