...
\begin{figure}[th]
	\begin{center}
		\includegraphics[width=.9\textwidth]{../Figures/HANK_multipliers.pdf}
		\caption{Consumption Multipliers over Different Horizons in the HANK Model}
		\notinsubfile{\label{fig:HANK_multipliers}}
	\end{center}
\end{figure}


Figure \ref{fig:HANK_multipliers} shows the consumption multipliers over different horizons under a fixed real rate rule. This figure can be compared to figure \ref{fig:cumulativemultipliers} which shows a similar figure in our partial equilibrium analysis. In both versions of the model, the consumption multipliers over time horizons are similar, with the effect of the tax cut substantially smaller than the stimulus check or UI extension policies, despite the inclusion of supply-side effects in this HANK model.
