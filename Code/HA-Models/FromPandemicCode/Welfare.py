...
def Welfare_Results(saved_results_dir,table_dir,Parametrization='Baseline'):
    ...
    output +="$\\mathcal{W}(\\text{policy}, Rec=1, AD=1)$ & "  + mystr2dp(recession_Check_consumption_welfareAD6)  + "  & "+ mystr2dp(recession_UI_consumption_welfareAD6)  +  "  & "+  mystr2dp(recession_TaxCut_consumption_welfareAD6)  + "     \\\\ \n"
    output +="\\end{tabular}  \n"
