...
recession_UI_results                = loadPickle('recessionUI_results',figs_dir,locals())       
recession_UI_results_AD             = loadPickle('recessionUI_results_AD',figs_dir,locals())  
...
recession_TaxCut_results            = loadPickle('recessionTaxCut_results',figs_dir,locals())
recession_TaxCut_results_AD         = loadPickle('recessionTaxCut_results_AD',figs_dir,locals())

recession_all_results                   = loadPickle('recession_all_results',figs_dir,locals())
recession_all_results_AD                = loadPickle('recession_all_results_AD',figs_dir,locals())
recession_UI_all_results                = loadPickle('recessionUI_all_results',figs_dir,locals())       
recession_UI_all_results_AD             = loadPickle('recessionUI_all_results_AD',figs_dir,locals())  
recession_Check_all_results             = loadPickle('recessionCheck_all_results',figs_dir,locals())       
recession_Check_all_results_AD          = loadPickle('recessionCheck_all_results_AD',figs_dir,locals())
recession_TaxCut_all_results            = loadPickle('recessionTaxCut_all_results',figs_dir,locals())
recession_TaxCut_all_results_AD         = loadPickle('recessionTaxCut_all_results_AD',figs_dir,locals())
...
output +="\\end{tabular}  \n"
with open('Tables/welfare1.tex','w') as f:
    f.write(output)
    f.close()
output  ="\\begin{tabular}{@{}lccc@{}} \n"
output +="\\toprule \n"
...
output +="\\end{tabular}  \n"
with open('Tables/welfare2.tex','w') as f:
    f.write(output)
    f.close()
