...
\ifbool{bundesb}{% set date for CEF
...
\ifbool{fullcon}{% set date for SSB workshop
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.4\textwidth}
			Liquid Wealth (Survey of Consumer Finances) 
			
			\includegraphics[width=\linewidth]{\FigDir/LorenzPoints.pdf}
			
			Modeling device: \textit{Ex-ante} heterogeneity in discount factors
